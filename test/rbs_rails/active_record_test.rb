...
class ActiveRecordTest < Minitest::Test
  ...
  def test_project_model_rbs_generation
    rbs_path = app_dir.join('sig/rbs_rails/app/models/project.rbs')
    expect_path = expectations_dir / 'project.rbs'
    # Code to re-generate the expectation files
    # expect_path.write rbs_path.read
  ...
  def test_tag_model_rbs_generation
    rbs_path = app_dir.join('sig/rbs_rails/app/models/tag.rbs')
    expect_path = expectations_dir / 'tag.rbs'
    # Code to re-generate the expectation files
    # expect_path.write rbs_path.read
