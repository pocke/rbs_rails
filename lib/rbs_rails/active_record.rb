module RbsRails
  module ActiveRecord
    ...
    class Generator
      ...
      private def enum_definitions #: Array[Hash[Symbol, untyped]]
      ...
      private def build_enum_definitions #: Array[Hash[Symbol, untyped]]
        ast = parse_model_file
        return [] unless ast
      ...
      # @rbs name: Symbol
      # @rbs label: Symbol
      private def enum_method_name(hash, name, label) #: String
